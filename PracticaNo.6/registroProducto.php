...
//SE OBTIENE EL ID Y NOMBRE DE CADA UNA DE LAS CATEGORÍAS REGISTRADAS EN LA BD MEDIANTE LA FUNCIÓN solicitar_id_nombre()
$categorias=solicitar_id_nombre();

//isset DEVUELVE TRUE SI EXISTE EL OBJETO (VARIABLE) Y TIENE UN VALOR DISTINTO DE NULL
//      DEVUELVE FALSE SI ES LO CONTRARIO
if (isset($_POST['codigo'], $_POST['nombre'], $_POST['descripcion'], $_POST['categoria'], $_POST['precio_venta'], $_POST['precio_compra'])){

    //SE INVOCA LA FUNCIÓN QUE AGREGA UN PRODUCTO Y SE LE PASAN COMO PARAMETRO LOS DATOS DE LOS INPUT
    crear_producto($_POST['codigo'], $_POST['nombre'], $_POST['descripcion'], $_POST['categoria'], $_POST['precio_venta'], $_POST['precio_compra']);

    //SE REDIRECCIONA A LA PÁGINA QUE CONTIENE LA TABLA DE PRODUCTOS
                                    ...
                                    <form action="registroProducto.php" method="POST">
                                        <div class="card-body">
                                            ...
                                            <select class="form-select" name="categoria" id="categoria" aria-label="Default select example" required>
                                                ...
                                                <?php
                                                //SE RECORRE LA MATRIZ QUE CONTIENE EL ID Y NOMBRE DE CADA UNA DE LAS CATEGORIAS, ESTO PARA MOSTRARLAS COMO OPCIONES
                                            ...
                                            <!-- PRECIO VENTA -->
                                            <div class="form-floating">
                                                <input type="number" class="form-control" name="precio_venta" id="precio_venta" placeholder="Ingrese el precio de venta" required>
                                            ...
                                            <!-- PRECIO COMPRA -->
                                            <div class="form-floating">
                                                <input type="number" class="form-control" name="precio_compra" id="precio_compra" placeholder="Ingrese el precio de compra" required>
