...
//SE INVOCA LA FUNCIÓN QUE RETORNA LA TABLA DE productos PERO EN LUGAR DE MOSTRAR EL id DE CATEGORÍA, SE MUESTRA EL NOMBRE
$tabla=solicitar_productos();
?>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <table id="example1" class="table table-bordered table-striped">
                                            ...
                                            <tbody>
                                                <!-- SE RECORRE LA MATRIZ QUE CONTIENE LA TABLA productos, ESTO PARA MOSTRARLA EN UNA TABLA HTML -->
