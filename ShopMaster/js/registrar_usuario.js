...
var formulario=document.getElementById('registrar_usuario');
$(document).ready(function () {
    ...
    $('#registrar_usuario').submit(function () {
        ...
        if ($('#nombre').val() != "" && $('#apellido').val() != "" && $('#username').val() != "" && $('#email').val() != "" && $('#password').val() != "") {
            ...
            $.ajax({
                ...
                url: "../controller/crtl-registrar_usuario.php",
        ...
        formulario.nombre.value=formulario.apellido.value=formulario.username.value=formulario.email.value=formulario.password.value='';
